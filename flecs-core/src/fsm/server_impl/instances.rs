...
use flecsd_axum_server::apis::instances::{
    ...
    InstancesInstanceIdConfigNetworksNetworkIdPutResponse,
...
use flecsd_axum_server::models::{
    ...
    InstancesInstanceIdConfigNetworksNetworkIdPutPathParams,
    ...
    > Instances for ServerImpl<APP, AUTH, I, L, Q, M, SYS, D, F, T, NET, NetDev>
{
    ...
    async fn instances_instance_id_config_networks_network_id_put(
        ...
        _host: Host,
        _cookies: CookieJar,
        _path_params: InstancesInstanceIdConfigNetworksNetworkIdPutPathParams,
        _body: models::InstanceConnectToNetworkConfig,
