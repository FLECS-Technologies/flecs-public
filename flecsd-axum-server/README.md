# Rust API for flecsd-axum-server
...
This autogenerated project defines an API crate `flecsd-axum-server` which contains:
...
#[async_trait]
impl flecsd-axum-server::Api for ServerImpl {
...
pub async fn start_server(addr: &str) {
    ...
    // Init Axum router
    let app = flecsd-axum-server::server::new(Arc::new(ServerImpl));
