...
auto module_instances_t::import_from(instance_id_t instance_id, fs::path base_path) //
    -> result_t
{
    return _impl->do_import_from_sync(std::move(instance_id), std::move(base_path));
}
