...
#include "flecs/api/lib/impl/libflecs_impl.h"
...
// app management
int libflecs_t::do_install_app(const std::string& app, const std::string& version, const std::string& license)
{
...
int libflecs_t::post(const std::string& endpoint, const char* data)
{
    ...
    _response =
        cpr::Post(build_url(endpoint), cpr::Header{{"Content-type", "application/json"}}, cpr::Body{data});
...
int libflecs_t::put(const std::string& endpoint, const char* data)
{
    ...
    _response =
        cpr::Put(build_url(endpoint), cpr::Header{{"Content-type", "application/x-yaml"}}, cpr::Body{data});
