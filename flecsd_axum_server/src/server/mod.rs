        ...
        + 'static,
{
    ...
    Router::new()
        ...
        .route("/v2/instances/:instance_id/config/ports/:transport_protocol/:host_port",
            delete(instances_instance_id_config_ports_transport_protocol_host_port_delete::<I, A>).get(instances_instance_id_config_ports_transport_protocol_host_port_get::<I, A>).put(instances_instance_id_config_ports_transport_protocol_host_port_put::<I, A>)
        )
        .route("/v2/instances/:instance_id/config/ports/:transport_protocol/:host_port_start-:host_port_end",
            delete(instances_instance_id_config_ports_transport_protocol_host_port_start_host_port_end_delete::<I, A>).get(instances_instance_id_config_ports_transport_protocol_host_port_start_host_port_end_get::<I, A>).put(instances_instance_id_config_ports_transport_protocol_host_port_start_host_port_end_put::<I, A>)
        )
...
#[tracing::instrument(skip_all)]
fn instances_instance_id_config_ports_transport_protocol_host_port_delete_validation(
    path_params: models::InstancesInstanceIdConfigPortsTransportProtocolHostPortDeletePathParams,
) -> std::result::Result<
    (models::InstancesInstanceIdConfigPortsTransportProtocolHostPortDeletePathParams,),
    ValidationErrors,
> {
    path_params.validate()?;
...
/// InstancesInstanceIdConfigPortsTransportProtocolHostPortDelete - DELETE /v2/instances/{instance_id}/config/ports/{transport_protocol}/{host_port}
#[tracing::instrument(skip_all)]
async fn instances_instance_id_config_ports_transport_protocol_host_port_delete<I, A>(
    method: Method,
    host: Host,
    cookies: CookieJar,
    Path(path_params): Path<
    ...
    A: apis::instances::Instances,
{
    #[allow(clippy::redundant_closure)]
    let validation = tokio::task::spawn_blocking(move || {
        instances_instance_id_config_ports_transport_protocol_host_port_delete_validation(
            path_params,
        )
    })
    .await
    ...
    let resp = match result {
                                            Ok(rsp) => match rsp {
                                                apis::instances::InstancesInstanceIdConfigPortsTransportProtocolHostPortDeleteResponse::Status200_Success
                                                => {
                                                  let mut response = response.status(200);
                                                  response.body(Body::empty())
                                                },
                                                apis::instances::InstancesInstanceIdConfigPortsTransportProtocolHostPortDeleteResponse::Status400_MalformedRequest
                                                    (body)
                                                => {
                                                  let mut response = response.status(400);
                                                  {
                                                ...
                                                apis::instances::InstancesInstanceIdConfigPortsTransportProtocolHostPortDeleteResponse::Status404_ResourceNotFound
                                                    (body)
                                                => {
                                                  let mut response = response.status(404);
                                                  {
...
#[tracing::instrument(skip_all)]
fn instances_instance_id_config_ports_transport_protocol_host_port_get_validation(
    path_params: models::InstancesInstanceIdConfigPortsTransportProtocolHostPortGetPathParams,
) -> std::result::Result<
    (models::InstancesInstanceIdConfigPortsTransportProtocolHostPortGetPathParams,),
    ValidationErrors,
> {
    path_params.validate()?;
...
/// InstancesInstanceIdConfigPortsTransportProtocolHostPortGet - GET /v2/instances/{instance_id}/config/ports/{transport_protocol}/{host_port}
#[tracing::instrument(skip_all)]
async fn instances_instance_id_config_ports_transport_protocol_host_port_get<I, A>(
    method: Method,
    host: Host,
    cookies: CookieJar,
    Path(path_params): Path<
    ...
    A: apis::instances::Instances,
{
    #[allow(clippy::redundant_closure)]
    let validation = tokio::task::spawn_blocking(move || {
        instances_instance_id_config_ports_transport_protocol_host_port_get_validation(path_params)
    })
    .await
    .unwrap();
    ...
    let resp = match result {
                                            Ok(rsp) => match rsp {
                                                apis::instances::InstancesInstanceIdConfigPortsTransportProtocolHostPortGetResponse::Status200_Success
                                                    (body)
                                                => {
                                                  let mut response = response.status(200);
                                                  {
                                                ...
                                                apis::instances::InstancesInstanceIdConfigPortsTransportProtocolHostPortGetResponse::Status400_MalformedRequest
                                                    (body)
                                                => {
                                                  let mut response = response.status(400);
                                                  {
                                                ...
                                                apis::instances::InstancesInstanceIdConfigPortsTransportProtocolHostPortGetResponse::Status404_ResourceNotFound
                                                    (body)
                                                => {
                                                  let mut response = response.status(404);
                                                  {
...
#[derive(validator::Validate)]
#[allow(dead_code)]
struct InstancesInstanceIdConfigPortsTransportProtocolHostPortPutBodyValidator<'a> {
    #[validate(nested)]
    body: &'a models::InstancesInstanceIdConfigPortsTransportProtocolHostPortPutRequest,
}

#[tracing::instrument(skip_all)]
fn instances_instance_id_config_ports_transport_protocol_host_port_put_validation(
    path_params: models::InstancesInstanceIdConfigPortsTransportProtocolHostPortPutPathParams,
    body: models::InstancesInstanceIdConfigPortsTransportProtocolHostPortPutRequest,
) -> std::result::Result<
    (
        models::InstancesInstanceIdConfigPortsTransportProtocolHostPortPutPathParams,
        models::InstancesInstanceIdConfigPortsTransportProtocolHostPortPutRequest,
    ),
    ValidationErrors,
> {
    path_params.validate()?;
    let b = InstancesInstanceIdConfigPortsTransportProtocolHostPortPutBodyValidator { body: &body };
    b.validate()?;

    Ok((path_params, body))
}
/// InstancesInstanceIdConfigPortsTransportProtocolHostPortPut - PUT /v2/instances/{instance_id}/config/ports/{transport_protocol}/{host_port}
#[tracing::instrument(skip_all)]
async fn instances_instance_id_config_ports_transport_protocol_host_port_put<I, A>(
    method: Method,
    host: Host,
    cookies: CookieJar,
    Path(path_params): Path<
    ...
    >,
    State(api_impl): State<I>,
    Json(body): Json<models::InstancesInstanceIdConfigPortsTransportProtocolHostPortPutRequest>,
) -> Result<Response, StatusCode>
where
    I: AsRef<A> + Send + Sync,
    A: apis::instances::Instances,
{
    #[allow(clippy::redundant_closure)]
    let validation = tokio::task::spawn_blocking(move || {
        instances_instance_id_config_ports_transport_protocol_host_port_put_validation(
            path_params,
            body,
        )
    })
    ...
    let resp = match result {
                                            Ok(rsp) => match rsp {
                                                apis::instances::InstancesInstanceIdConfigPortsTransportProtocolHostPortPutResponse::Status200_TheSpecifiedPortMappingWasSet
                                                => {
                                                  let mut response = response.status(200);
                                                  response.body(Body::empty())
                                                },
                                                apis::instances::InstancesInstanceIdConfigPortsTransportProtocolHostPortPutResponse::Status201_TheSpecifiedPortMappingWasCreated
                                                => {
                                                  let mut response = response.status(201);
                                                  response.body(Body::empty())
                                                },
                                                apis::instances::InstancesInstanceIdConfigPortsTransportProtocolHostPortPutResponse::Status400_MalformedRequest
                                                    (body)
                                                => {
                                                  let mut response = response.status(400);
                                                  {
                                                ...
                                                apis::instances::InstancesInstanceIdConfigPortsTransportProtocolHostPortPutResponse::Status404_ResourceNotFound
                                                    (body)
                                                => {
                                                  let mut response = response.status(404);
                                                  {
...
#[tracing::instrument(skip_all)]
fn instances_instance_id_config_ports_transport_protocol_host_port_start_host_port_end_delete_validation(
  path_params: models::InstancesInstanceIdConfigPortsTransportProtocolHostPortStartHostPortEndDeletePathParams,
) -> std::result::Result<(
  models::InstancesInstanceIdConfigPortsTransportProtocolHostPortStartHostPortEndDeletePathParams,
), ValidationErrors>
{
    path_params.validate()?;
...
/// InstancesInstanceIdConfigPortsTransportProtocolHostPortStartHostPortEndDelete - DELETE /v2/instances/{instance_id}/config/ports/{transport_protocol}/{host_port_start}-{host_port_end}
#[tracing::instrument(skip_all)]
...
>(
    ...
    host: Host,
    cookies: CookieJar,
    Path(path_params): Path<models::InstancesInstanceIdConfigPortsTransportProtocolHostPortStartHostPortEndDeletePathParams>,
    State(api_impl): State<I>,
) -> Result<Response, StatusCode>
where
    I: AsRef<A> + Send + Sync,
    A: apis::instances::Instances,
{
    #[allow(clippy::redundant_closure)]
      let validation = tokio::task::spawn_blocking(move ||
    instances_instance_id_config_ports_transport_protocol_host_port_start_host_port_end_delete_validation(
        path_params,
    )
  ).await.unwrap();
    ...
    let resp = match result {
                                            Ok(rsp) => match rsp {
                                                apis::instances::InstancesInstanceIdConfigPortsTransportProtocolHostPortStartHostPortEndDeleteResponse::Status200_Success
                                                => {
                                                  let mut response = response.status(200);
                                                  response.body(Body::empty())
                                                },
                                                apis::instances::InstancesInstanceIdConfigPortsTransportProtocolHostPortStartHostPortEndDeleteResponse::Status400_MalformedRequest
                                                    (body)
                                                => {
                                                  let mut response = response.status(400);
                                                  {
                                                ...
                                                apis::instances::InstancesInstanceIdConfigPortsTransportProtocolHostPortStartHostPortEndDeleteResponse::Status404_ResourceNotFound
                                                    (body)
                                                => {
                                                  let mut response = response.status(404);
                                                  {
...
#[tracing::instrument(skip_all)]
fn instances_instance_id_config_ports_transport_protocol_host_port_start_host_port_end_get_validation(
  path_params: models::InstancesInstanceIdConfigPortsTransportProtocolHostPortStartHostPortEndGetPathParams,
) -> std::result::Result<(
  models::InstancesInstanceIdConfigPortsTransportProtocolHostPortStartHostPortEndGetPathParams,
), ValidationErrors>
{
    path_params.validate()?;
...
/// InstancesInstanceIdConfigPortsTransportProtocolHostPortStartHostPortEndGet - GET /v2/instances/{instance_id}/config/ports/{transport_protocol}/{host_port_start}-{host_port_end}
#[tracing::instrument(skip_all)]
...
>(
    ...
    host: Host,
    cookies: CookieJar,
    Path(path_params): Path<models::InstancesInstanceIdConfigPortsTransportProtocolHostPortStartHostPortEndGetPathParams>,
    State(api_impl): State<I>,
) -> Result<Response, StatusCode>
where
    I: AsRef<A> + Send + Sync,
    A: apis::instances::Instances,
{
    #[allow(clippy::redundant_closure)]
      let validation = tokio::task::spawn_blocking(move ||
    instances_instance_id_config_ports_transport_protocol_host_port_start_host_port_end_get_validation(
        path_params,
    )
  ).await.unwrap();
    ...
    let resp = match result {
                                            Ok(rsp) => match rsp {
                                                apis::instances::InstancesInstanceIdConfigPortsTransportProtocolHostPortStartHostPortEndGetResponse::Status200_Success
                                                    (body)
                                                => {
                                                  let mut response = response.status(200);
                                                  {
                                                ...
                                                apis::instances::InstancesInstanceIdConfigPortsTransportProtocolHostPortStartHostPortEndGetResponse::Status400_MalformedRequest
                                                    (body)
                                                => {
                                                  let mut response = response.status(400);
                                                  {
                                                ...
                                                apis::instances::InstancesInstanceIdConfigPortsTransportProtocolHostPortStartHostPortEndGetResponse::Status404_ResourceNotFound
                                                    (body)
                                                => {
                                                  let mut response = response.status(404);
                                                  {
...
#[derive(validator::Validate)]
#[allow(dead_code)]
struct InstancesInstanceIdConfigPortsTransportProtocolHostPortStartHostPortEndPutBodyValidator<'a> {
            #[validate(nested)]
          body: &'a models::InstancesInstanceIdConfigPortsTransportProtocolHostPortStartHostPortEndPutRequest,
    }

#[tracing::instrument(skip_all)]
fn instances_instance_id_config_ports_transport_protocol_host_port_start_host_port_end_put_validation(
  path_params: models::InstancesInstanceIdConfigPortsTransportProtocolHostPortStartHostPortEndPutPathParams,
        body: models::InstancesInstanceIdConfigPortsTransportProtocolHostPortStartHostPortEndPutRequest,
) -> std::result::Result<(
  models::InstancesInstanceIdConfigPortsTransportProtocolHostPortStartHostPortEndPutPathParams,
        models::InstancesInstanceIdConfigPortsTransportProtocolHostPortStartHostPortEndPutRequest,
), ValidationErrors>
{
    path_params.validate()?;
    let b =
        InstancesInstanceIdConfigPortsTransportProtocolHostPortStartHostPortEndPutBodyValidator {
            body: &body,
        };
    b.validate()?;
...
/// InstancesInstanceIdConfigPortsTransportProtocolHostPortStartHostPortEndPut - PUT /v2/instances/{instance_id}/config/ports/{transport_protocol}/{host_port_start}-{host_port_end}
#[tracing::instrument(skip_all)]
...
>(
    ...
    host: Host,
    cookies: CookieJar,
    Path(path_params): Path<models::InstancesInstanceIdConfigPortsTransportProtocolHostPortStartHostPortEndPutPathParams>,
    State(api_impl): State<I>,
    Json(body): Json<
        models::InstancesInstanceIdConfigPortsTransportProtocolHostPortStartHostPortEndPutRequest,
    >,
    ...
    A: apis::instances::Instances,
{
    #[allow(clippy::redundant_closure)]
      let validation = tokio::task::spawn_blocking(move ||
    instances_instance_id_config_ports_transport_protocol_host_port_start_host_port_end_put_validation(
        path_params,
          body,
    )
  ).await.unwrap();
    ...
    let resp = match result {
                                            Ok(rsp) => match rsp {
                                                apis::instances::InstancesInstanceIdConfigPortsTransportProtocolHostPortStartHostPortEndPutResponse::Status200_TheSpecifiedPortMappingWasSet
                                                => {
                                                  let mut response = response.status(200);
                                                  response.body(Body::empty())
                                                },
                                                apis::instances::InstancesInstanceIdConfigPortsTransportProtocolHostPortStartHostPortEndPutResponse::Status201_TheSpecifiedPortMappingWasCreated
                                                => {
                                                  let mut response = response.status(201);
                                                  response.body(Body::empty())
                                                },
                                                apis::instances::InstancesInstanceIdConfigPortsTransportProtocolHostPortStartHostPortEndPutResponse::Status400_MalformedRequest
                                                    (body)
                                                => {
                                                  let mut response = response.status(400);
                                                  {
                                                ...
                                                apis::instances::InstancesInstanceIdConfigPortsTransportProtocolHostPortStartHostPortEndPutResponse::Status404_ResourceNotFound
                                                    (body)
                                                => {
                                                  let mut response = response.status(404);
                                                  {
