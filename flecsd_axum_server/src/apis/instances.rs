...
#[must_use]
#[allow(clippy::large_enum_variant)]
pub enum InstancesInstanceIdConfigPortsTransportProtocolHostPortDeleteResponse {
    /// Success
    Status200_Success,
    /// Malformed request
    Status400_MalformedRequest(models::AdditionalInfo),
...
#[must_use]
#[allow(clippy::large_enum_variant)]
pub enum InstancesInstanceIdConfigPortsTransportProtocolHostPortGetResponse {
    /// Success
    Status200_Success(i32),
    /// Malformed request
    Status400_MalformedRequest(models::AdditionalInfo),
    /// Resource not found
    Status404_ResourceNotFound(models::OptionalAdditionalInfo),
...
#[must_use]
#[allow(clippy::large_enum_variant)]
pub enum InstancesInstanceIdConfigPortsTransportProtocolHostPortPutResponse {
    /// The specified port mapping was set, the previous mapping of the host port was overwritten
...
#[must_use]
#[allow(clippy::large_enum_variant)]
pub enum InstancesInstanceIdConfigPortsTransportProtocolHostPortStartHostPortEndDeleteResponse {
    /// Success
    Status200_Success,
    /// Malformed request
    Status400_MalformedRequest(models::AdditionalInfo),
...
#[must_use]
#[allow(clippy::large_enum_variant)]
pub enum InstancesInstanceIdConfigPortsTransportProtocolHostPortStartHostPortEndGetResponse {
    /// Success
    Status200_Success(models::PortRange),
    /// Malformed request
    Status400_MalformedRequest(models::AdditionalInfo),
    /// Resource not found
    Status404_ResourceNotFound(models::OptionalAdditionalInfo),
...
#[must_use]
#[allow(clippy::large_enum_variant)]
pub enum InstancesInstanceIdConfigPortsTransportProtocolHostPortStartHostPortEndPutResponse {
...
pub trait Instances {
    ...
    /// Remove port mapping from the given host_port to the instance.
    ///
    ...
    /// Retrieve instance port that is mapped to the given host_port.
    ///
    ...
    /// Create or update port mapping to the given host_port.
    ///
